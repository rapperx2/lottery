...
import com.qihang.footballreptile.FootballlotteryProcessor;
...
public class StaticScheduleTask {
    ...
    @Resource
    private FootballlotteryProcessor footballlotteryProcessor;
    ...
    private void configureProcessorlotteryTasks() {
        //执行爬虫
        footballlotteryProcessor.run();
    }
