...
public class FollowController {
    ...
    @GetMapping("/listadmin/{type}/{userid}")
    @ApiOperation("关注|粉丝列表接口")
    public CommonListVO<UserVO> listadmin(@PathVariable("type") String type,@PathVariable("userid") Integer userid) {
        return followService.list(type, userid);
    }
}
