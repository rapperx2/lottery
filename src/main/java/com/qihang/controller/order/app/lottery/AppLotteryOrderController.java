...
public class AppLotteryOrderController {
    ...
    @ApiOperation("店铺购彩订单记录接口")
    public CommonListVO<LotteryOrderVO> getShopLotteryOrderPage(@RequestBody @Valid LotteryOrderDTO lotteryOrder) {
        return lotteryOrderService.getShopLotteryOrderPage(lotteryOrder);
    }
