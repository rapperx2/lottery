...
public class AdminLotteryOrderController {
    ...
    public CommonListVO<LotteryOrderQueryVO> getLotteryOrderPage(@RequestBody @Valid LotteryOrderQueryDTO lotteryOrderQuery) {
        ...
        return lotteryOrderService.getAdminLotteryOrderPage(lotteryOrderQuery,Integer.parseInt(servletRequestAttributes.getRequest().getHeader("X-Tenant-Id")));
    }
    @PostMapping("/pic")
    @ApiOperation("出票审核接口")
    public BaseVO ticketing(@RequestBody @Valid LotteryOrderadminDTO lotteryOrderpic) {
        return lotteryOrderService.updatepic(lotteryOrderpic);
    }
