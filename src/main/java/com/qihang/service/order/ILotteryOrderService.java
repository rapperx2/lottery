...
public interface ILotteryOrderService extends IService<LotteryOrderDO> {
    ...
    BaseVO updatepic(LotteryOrderadminDTO lotteryOrderpic);
    ...
    CommonListVO<LotteryOrderQueryVO> getAdminLotteryOrderPage(LotteryOrderQueryDTO lotteryOrderQuery, int tid);
    ...
    CommonListVO<LotteryOrderVO> getShopLotteryOrderPage(LotteryOrderDTO lotteryOrder);
}
